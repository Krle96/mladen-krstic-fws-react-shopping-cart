...
var Menu = {
  ...
  init: function init() {
    ...
    function closeNav() {
      ...
      _global__WEBPACK_IMPORTED_MODULE_0__["default"].$domBody.removeClass(Menu.classOpenMenu);
    }

    if (_global__WEBPACK_IMPORTED_MODULE_0__["default"].varsWindowWidth < 768) {
    ...
    this.$domMenuBtn.on('click', function (e) {
      ...
      _global__WEBPACK_IMPORTED_MODULE_0__["default"].$domBody.toggleClass(Menu.classOpenMenu);
    });
    ...
    _global__WEBPACK_IMPORTED_MODULE_0__["default"].functions.clickOutsideContainer(this.$domMenuNav, this.$domMenuNav.children('ul'), this.$domMenuBtn, closeNav);
    _global__WEBPACK_IMPORTED_MODULE_0__["default"].functions.escKey(closeNav);
  }
};
